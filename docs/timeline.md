...
- **2026-08-15** — Cut the dev-branch section in half — the accretion was generating the defects, not fixing them *(docs/dev-branch-convention)* — [decisions-branches/docs__dev-branch-convention.md](decisions-branches/docs__dev-branch-convention.md)
- *... 16 more decisions ...*
